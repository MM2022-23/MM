  ...
  return (
    <section style={{ fontFamily: "Signika", padding: "10px" }}>
      ...
      <div className="container">
        <p className="lead">Last updated: January 3, 2023</p>
        <p className="my-3">
      ...
      <div className="container my-5">
        ...
        <div className="row">
          <div className="col mb-3">
            <strong className="text-dark mx-1" style={{ fontSize: "large" }}>
              Account
            </strong>
      ...
      <h2 className="container">Collecting and Using Your Personal Data</h2>
      <div className="container my-3">
        ...
        <p className="my-2">First name and last name</p>
        <p className="my-2">Phone number</p>
        <p className="my-2">Address, State, Province, ZIP/Postal code, City</p>
        <p className="my-2">Usage Data</p>
      </div>

      <div className="container my-3">
        <h4>Types of Data Collected: Usage Data</h4>
      ...
      <div className="container my-3">
        ...
        <p className="mb-2">
          ...
          under the age of 13. In the case We discover that a child under 13 has
          ...
          us so that We will be able to necessary actions.
        </p>
