...
class DataCollectionAPI {
  ...
  createSession(dataToSend){
    return axios.post(`${DATACOLLECTION_BASE_REST_API_URL}userSession`, dataToSend);
  }
...
// { sessionID,timeOfRecord,userInfo,zipCode,mealSize,deliveryDateSelected,activity }
  orderPageDataCollect(dataToSend){
    return axios.post(`${DATACOLLECTION_BASE_REST_API_URL}orderPageDataCollect`, dataToSend);
  }
  ...
  pickMealsPageDataCollection(dataToSend){
    return axios.post(`${DATACOLLECTION_BASE_REST_API_URL}pickMealsPageDataCollection`, dataToSend);
  }

  // UPDATE FBINFO
  // { sessionID, fbInfo }
  updatefbInfo(dataToSend){
      return axios.post(`${DATACOLLECTION_BASE_REST_API_URL}updatefbInfo`, dataToSend);
  }
